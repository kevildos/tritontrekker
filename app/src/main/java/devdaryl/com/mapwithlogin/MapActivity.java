        ...
        LocationListener
{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //moves button to bottom right of map but also moves the current location center
    ...
    private void setUpMarkerClickListener() {
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Double lat = markLoc.latitude;
                Double lon = markLoc.longitude;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == Activity.RESULT_OK) {
                String lat = data.getStringExtra("latit");
                String lon = data.getStringExtra("longit");

                LatLng forDirections = new LatLng(Double.parseDouble(lat), Double.parseDouble(lon));
                calculateDirections(forDirections);
            }
        }
    }//onActivityResult
    ...
    //searches database first, if nothing comes up, then searches google database
